...
export const vegasLightColors = [
  ...
  { id: 3, name: "Soft Lavender", hex: "#C8CEDF", description: "Secondary accent", textColor: "black" },
  { id: 4, name: "Royal Blue", hex: "#296CB5", description: "Primary accent", textColor: "white" },
  { id: 5, name: "Peach", hex: "#FDDBCA", description: "Warm highlight", textColor: "black" },
];

export const vegasDarkColors = [
  { id: 1, name: "Black", hex: "#000000", description: "Background", textColor: "white" },
  { id: 2, name: "White", hex: "#FFFFFF", description: "Primary text", textColor: "black" },
  { id: 3, name: "Ice Blue", hex: "#CCDEE2", description: "Cool accent", textColor: "black" },
  { id: 4, name: "Deep Teal", hex: "#23577A", description: "Secondary accent", textColor: "white" },
  { id: 5, name: "Blush Pink", hex: "#F1BFD9", description: "Soft highlight", textColor: "black" },
  { id: 6, name: "Hot Red", hex: "#ED174B", description: "Bold accent", textColor: "white" },
  { id: 7, name: "Warm Peach", hex: "#FEDCBB", description: "Warm tone", textColor: "black" },
  { id: 8, name: "Bright Red", hex: "#ED2024", description: "Alert accent", textColor: "white" },
  { id: 9, name: "Sage Green", hex: "#DAE0CE", description: "Natural balance", textColor: "black" },
  { id: 10, name: "Vivid Green", hex: "#38B14A", description: "Life accent", textColor: "white" },
];
