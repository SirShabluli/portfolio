...
export default function GlassCard({
  ...
  return (
    <div className="relative group p-[px] rounded-lg overflow-hidden">
      ...
      <div className="relative bg-white/5 backdrop-blur-[4px] rounded-[25px] overflow-hidden border border-white/10 shadow-2xl transition-all duration-500 hover:bg-white/10">
